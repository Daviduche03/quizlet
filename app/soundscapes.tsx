...
const FILTER_TABS = ['All', 'Nature', 'Instrumental'];

const MOCK_SOUNDSCAPE_DATA = [
    {
        id: '1',
        title: 'Forest',
...
export default function SoundscapesScreen() {
    ...
    const filteredData = activeTab === 'All'
        ? MOCK_SOUNDSCAPE_DATA
        : MOCK_SOUNDSCAPE_DATA.filter(item => item.type === activeTab);
        ...
        <>
            ...
            <View className="flex-1 bg-[#1c1c1e]">
                ...
                <View className="flex-row items-center pt-14 pb-4 px-6">
                    ...
                    <Text className="flex-1 text-center text-white text-lg font-bold mr-10">Soundscapes</Text>
                </View>
                ...
                <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
                    {filteredData.map((item) => (
                        ...
                        >
                            ...
                            <View className="w-8 h-8 rounded-full bg-[#3a3a3c] items-center justify-center">
